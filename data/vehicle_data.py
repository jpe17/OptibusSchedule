from event import Deadhead, ServiceTrip
from event_container import Vehicle

vehicles = [
    Vehicle(
        [
            Deadhead('pull_out', '08:05', '08:20', 'A', 'B'),
    ...
    Vehicle(
        [
            Deadhead('pull_out', '08:00', '08:05', 'A', 'B'),
    ...
    Vehicle(
        [
            ...
            Deadhead('pull_out', '25:30', '25:31', 'C', 'A')
        ], "Standard"
    ),
    Vehicle(
        [
            ServiceTrip('1A', '12:00', '14:00', 'A', 'C'),
            Deadhead('pull_out', '14:00', '14:05', 'C', 'A')
        ], "Standard"
    ),
    Vehicle(
        [
